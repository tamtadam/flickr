...
def upload_single_folder(
    folder: str, api_key: str = "", api_secret: str = "", upload_failed: bool = False, upload_root: str = UPLOAD_ROOT, year_set: str = "__2026__"
) -> None:
...
def upload_multiple_folders(
    folders: list[str], api_key: str = "", api_secret: str = "", upload_failed: bool = False, upload_root: str = UPLOAD_ROOT, year_set: str = "__2026__"
) -> None:
